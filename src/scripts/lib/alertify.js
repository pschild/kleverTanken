	...
	Alertify = function () {
		...
		dialogs = {
			buttons : {
				...
				*/
				holder : "<nav class=\"alertify-buttons\">{{buttons}}</nav>",
				submit : "<button type=\"submit\" class=\"btn btn-large btn-success\" id=\"alertify-ok\">{{ok}}</button>",
				ok     : "<button class=\"btn btn-large btn-success\" id=\"alertify-ok\">{{ok}}</button>",
				cancel : "<button class=\"btn btn-large btn-danger\" id=\"alertify-cancel\">{{cancel}}</button>"
			},
